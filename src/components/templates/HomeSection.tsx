...
import Section from "../parts/SectionItem";

const HomeSection = () => {
  const whatHaveTodoText = `HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載HaveTodoとは？の文言を記載`;
  ...
  return (
    <main className="home">
      ...
      <Section
        ...
        id="section2"
      />
      <Section title="使い方" subtitle={howToText} dark={true} id="section3" />
      <Section
        title="みんなの声"
